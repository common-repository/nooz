<div class="nooz-release-content-wrapper nooz-content-wrapper nooz-release__content">
    <?php if ( ! empty( $data['subheadline'] ) ) { ?>
        <h2 class="nooz-subheadline nooz-release__subheadline"><?php echo wp_kses_post( $data['subheadline'] ); ?></h2>
    <?php } ?>
    <div class="nooz-body-container nooz-container">
        ...
        <?php if ( ! empty( $data['ending'] ) ) { ?>
            <p class="nooz-ending nooz-release__ending"><?php echo $data['ending']; ?></p>
        <?php } ?>
